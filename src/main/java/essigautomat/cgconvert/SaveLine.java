...
public class SaveLine {
	...
	public void writeStringToFile(String outputDir, String s) {
		writer = null;
		String outputFile = "all-in-one.cpp";
		if (outputDir != null && outputDir.length() != 0) {
			if (outputDir.charAt(outputDir.length() - 1) != '/')
	...
	private void writeLine(String s) {
		// Handle shortest mode: remove whitespaces, trim, remove single line comments,
		// remove empty lines
		if (m == Mode.SHORTEST) {
